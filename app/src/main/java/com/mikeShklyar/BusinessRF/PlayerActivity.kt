...
import com.mikeShklyar.BusinessRF.databinding.ActivityPlayerBinding
import com.mikeShklyar.BusinessRF.databinding.AudioBoosterBinding
    ...
    private fun setLayout(){
        ...
        val image = if (img != null) {
            ...
            BitmapFactory.decodeResource(
                resources,
                R.drawable.BusinessRF_icon_slash_screen
            )
        }
