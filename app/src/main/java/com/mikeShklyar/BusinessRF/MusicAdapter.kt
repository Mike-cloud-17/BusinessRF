package com.mikeShklyar.BusinessRF
...
import com.mikeShklyar.BusinessRF.MusicAdapter.MyHolder
import com.mikeShklyar.BusinessRF.databinding.DetailsViewBinding
import com.mikeShklyar.BusinessRF.databinding.MoreFeaturesBinding
import com.mikeShklyar.BusinessRF.databinding.MusicViewBinding
...
private val selectionActivity: Boolean = false)
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(RequestOptions().placeholder(R.drawable.BusinessRF_icon_slash_screen).centerCrop())
            .into(holder.image)
